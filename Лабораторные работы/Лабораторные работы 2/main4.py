...
total_chars = (lines * chars) * pages # TODO общее количество символов в книге
total_bytes = total_chars * BYTES_ONE_CHAR  # TODO размер одной книги в байтах
disk_size_MB = 1.44
disk_size = disk_size_MB * 1024 * 1024  # TODO размер дискеты в байтах

print(round(disk_size // total_bytes, 1))  # TODO найти количество книг, которое поместится на дискете
